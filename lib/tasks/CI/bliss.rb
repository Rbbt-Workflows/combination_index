...
module CombinationIndex
  ...
  #  ]
  #end
  task :bliss => :text do |blue_doses,blue_responses,red_doses,red_responses,blue_dose,red_dose,response,fix_ratio,model_type,more_doses,more_responses, direct_ci, response_type|
